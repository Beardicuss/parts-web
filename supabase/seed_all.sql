...
insert into public.parts (code, replacement_codes, compatible_models, title_en, title_ka, description_en, description_ka, brand_id, category_id, image_path, image_thumbnail_path, publication_status) values (
